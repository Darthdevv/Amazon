    ...
    <div className="w-full bg-amazon_light text-white">
      ...
      <div className="w-full flex gap-6 items-center justify-center py-6">
        ...
        <div className="flex gap-2">
          ...
          <div className="flex gap-3 items-center justify-center border border-gray-500 hover:border-amazon_yellow cursor-pointer duration-200 px-2 py-1">
            <img className="w-6" src={egyptFlag} alt="" />
            <p>Egypt</p>
          </div>
        </div>
      </div>
